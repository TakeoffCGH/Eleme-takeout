...
import { emit } from 'process';
    ...
    interface IProps{
        ...
        placeholder?:string
        shape?:string //组件的外轮廓
        modelValue?:string | number//组件输入框的值（可选）
    }
      ...
      <div class="op-cell op-search__field">
        ...
        <div class="op-cell__value">
          <div class="op-field__body">
            <!-- modelValue,onKeypress,inputClick,update:modelValue -->
            <input
              type="search"
            ...
            />
            <!-- 如果右边栏的icon则插槽插入right-icon, 如果搜索框有值则显示op-field__clear,点击则触发onClear -->
