...
<template>
  <div class="me-page">
    ...
    <OpLoadingView :loading="pending" type="skeleton">
      ...
      <div class="me-page__card" v-for="cards in data.cards" :key="cards.label">
          <div class="me-page__card__title">{{ cards.label }}</div>
          <div class="me-page__card__items">
              <div class="me-page__card__item" v-for="item in cards.items" :key="item.iconUrl">
                  <VanIcon :name="item.iconUrl" :size="cards.size"></VanIcon>
                  <div class="label">
      ...
      &__super-card{
        ...
        .super-card__left{
          ...
          &__top{
            ...
            .divider{
                position: relative;
                // 实际的width,height并不满足ui的需求，使用为元素可以撑大形状而不占位置
                width: 1px;
                height: 20px;
                margin: 0 10px;
                &:before{
